...
export default function OikOSPage() {
  return (
    <div className="w-full overflow-x-hidden bg-[#1B6B3D] font-sans text-white antialiased">
      {/* SECTION 1 — HERO */}
      <section className="mx-auto flex max-w-[1280px] flex-wrap items-center gap-16 px-6 pb-24 pt-24 md:px-12 md:pt-[120px] md:pb-[100px]">
        ...
        <Reveal direction="right" className="relative h-[460px] min-w-[340px] flex-1 basis-[520px]">
          ...
          <div className="absolute bottom-[-18px] right-[4%] h-[220px] w-[108px] rounded-[22px] border border-white/10 bg-[#1B6B3D] p-2 shadow-[0_20px_40px_-14px_rgba(0,0,0,0.5)]">
      ...
      <InmobiliariasSection bg="#1B6B3D" />

      <AutomotorasSection bg="#1B6B3D" />

      <HospitalitySection bg="#1B6B3D" />

      <ArquitecturaSection bg="#1B6B3D" />

      <GaleriaSection bg="#1B6B3D" />

      <PrimeraImpresion bg="#1B6B3D" />

      <Reveal direction="left">
        <OpportunitiesSection bg="#1B6B3D" />
      </Reveal>

      <ProblemSection bg="#1B6B3D" />

      <CasosReales bg="#1B6B3D" />

      <NuestroEnfoque bg="#1B6B3D" />

      <PuntaDelEste bg="#1B6B3D" />

      <TuNegocio bg="#1B6B3D" />

      {/* SECTION 3 — FEATURES */}
      <section className="bg-[#1B6B3D] px-6 py-24 md:px-12">
      ...
      <FAQSection bg="#1B6B3D" />

      {/* SECTION 7 — CTA */}
      <section id="assessment" className="bg-[#1B6B3D] px-6 py-[120px] text-center md:px-12">
